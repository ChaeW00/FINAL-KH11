	 		...
	 		<div class="chat-container position-fixed bottom-0 end-0 border rounded-3 bg-white" v-if="chatVisible">
        		...
        		<div class="row">
            		<div class="col-lg-5 col-md-12 mb-4">
                		...
                		<br>
                		<span style="color: white;">주식회사 KH컴퍼니 | 사업자번호 000-00-00000 | 대표 임채우 | 통신판매업 신고 0000-서울영등포-0000</span>
                		<br>
            		...
            		<div class="col-lg-3 col-md-6 mb-4">
                		<h5 class="mb-1 mt-5" style="letter-spacing: 2px; color: white;">Open Times</h5>
                		<table class="table" style="color: white;">
                    		<tbody>
                        		<tr>
                            		<td>월요일 - 일요일 :</td>
                            		<td>오전 6:00 - 오후 10:00</td>
                        		</tr>
                    		</tbody>
                		</table>
            		</div>
