...
<div class="container-fluid mt-4 custom-container" id="app">
	<div class="row mt-5">
	...
	<!-- 추가된 코드 -->
    		...
    		<div class="row">
      			...
      			<!-- 두번째 구역 -->
      			<div class="col-md-4">
      				 <button type="button" class="btn btn-primary w-100" v-on:click="showModal">참가하기</button>
      			</div>
      			
      			<!-- 모달 창 -->
				<div class="modal mt-5" tabindex="-1" role="dialog" id="modal03"
